...
import './SliderProductosTourStyles.css';
...
const SliderProductosTour = () => {
  ...
  return (
    ...
    <div className="titulo-slider" id="productos">
        <h1 className="py-3 my-4 titulo-principal1">¡Otros Tours!</h1>
        ...
        <div className="d-none" onClick={()=>gotoNext()}><GrNext className='boton-slider-next d-none'/></div> */}
          ...
          {userInfo && (
            <>
            {product.destacado && (<p className="estrella-tour-slider"><AiFillStar/></p>)}
...
export default SliderProductosTour