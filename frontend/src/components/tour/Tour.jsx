...
import SliderProductosTour from "../slider-productos-tour/SliderProductosTour";
// import SliderProductoPrincipal from "../slider-producto-principal/SliderProductoPrincipal";
...
// import './SliderProductosStyle.css';
...
// import SliderProductosPrincipal from "../slider-producto-principal/SliderProductoPrincipal";
  ...
  return (
    ...
    duration: 1
            ...
            {width < breakpoint ? (
              <>
                  ...
                  <div className="d-flex justify-content-between align-items-start contendor-titulo-producto">
                    <h1 className="titulo-producto">{product.name}{product.destacado && (<AiFillStar/>)}</h1>
                  ...
                  <div className="mt-4">
                      <ListGroupItem>
                        <div className="d-grid contenedor-boton-reservar">
            ...
            <Col md={5}>
              <div className="contendor-titulo-producto">
                <div className="contenedor-interno-titulo-producto">
                  ...
                  {product.destacado && (<AiFillStar className="estrella-producto"/>)}
      ...
      <Col md={12}>
        <div>
            ...
            <div className="texto-descripcion-gral" dangerouslySetInnerHTML={{__html: product.descriptionSecundaria}}/>
        </div>
        ...
        <div>
            ...
            <div className="informacion-adicional" dangerouslySetInnerHTML={{__html: product.infoAdicional}}/>
        </div>

        <hr className="separador-productos-interno"></hr>

        {/* <h1 className="titulos-responsive-modal-producto">Más imágenes del producto</h1> */}

        {/* <div className="contenedor-modal-producto">
          
            {[...product.images, product.image, ].map((x) => (
              <>
                <div className=''>
                  <img src={x} className="imagen-galeria-modal img-fluid" data-bs-toggle="modal" data-bs-target="#imagen1" data-bs-imagen={x} alt="img-modal1"/>
                </div>
                  ...
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content modal-content-centered">
                      <div className="modal-body">
                        <img src={x} className="img-fluid imagen-modal" data-bs-toggle={x} data-bs-target="#exampleModal" alt="img-modal1"/>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="contenedor-modal-producto">
            ...
            {/* {[...product.moreimages].map((x) => (
              <> */}
                {/* <div className='modal-dialog'>
                  <img className="imagen-galeria-modal img-fluid" src={x} onClick={handleShow} data-bs-toggle="modal" data-bs-target="#imagen1" data-bs-imagen={x} alt="img-modal1" />
                </div>    */}
    ...
    <Row className="separacion-listados">
      ...
      <Col className="mt-5" md={5}>
          <ListGroup variant="flush">
            <h2 className="titulos-responsive fs-1">Tours</h2>
            {prodfiltrado.map((product)=>(

              

            <ListGroup.Item key={product._id} className="p-0 mt-3 contenedor-categorias">              
                <Link className="link-categorias-related mb-3 fs-2" to={`/product/${product.slug}`}>{product.category}
      ...
      <Col className="mt-5" md={5}>
          <ListGroup variant="flush">
            <h2 className="titulos-responsiv fs-1">Destacados</h2>
