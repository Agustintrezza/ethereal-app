...
import './SliderProductoPaqueteStyles.css';
...
const SliderProductosPaquete = () => {
  ...
  return (
    ...
    <div className="titulo-slider" id="productos">
        <h1 className="py-3 my-4 titulo-principal1">¡Otras Paquetes!</h1>
            ...
            <Card.Body>
                ...
                {/* <Rating rating={product.rating} numReviews={product.numReviews}></Rating> */}
                    ...
                    <div className="contenedor-texto-card-all">
                        {/* <Card.Text className="fs-2 fw-bold">${product.price}</Card.Text> */}
                        {product.countInStock === 0? <Button variant='light' disabled>No hay Stock!</Button>
                        : 
...
export default SliderProductosPaquete